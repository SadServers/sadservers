...
Use exactly two digits to the right of the decimal point. i. e., <b>use exaclty two "decimal digits" without any rounding</b>. Eg: if average = 21.349 , the solution is 21.34. If average = 33.1 , the solution is 33.10.<br><br>
